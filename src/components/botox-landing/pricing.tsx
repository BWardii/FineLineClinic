      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative border-2 border-[#D6B28A] rounded-2xl p-6 shadow-md">
            ...
            <OpenWidgetButton ariaLabel="Claim 3-for-2" className="mt-6 inline-flex justify-center w-full rounded-full bg-[#D6B28A] text-[#221a16] py-3 font-semibold hover:brightness-110">Claim 3‑for‑2</OpenWidgetButton>
          </div>
          <div className="border rounded-2xl p-6 shadow-sm hover:shadow transition">
