...
export default function Slideshow({ slides, interval = 6000, children }: SlideshowProps) {
  ...
  return (
    <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
      ...
      {/* Arrows */}
      <button
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 transition-all focus:outline-none"
      ...
      <button
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-black/40 hover:bg-black/60 text-white rounded-full p-2 transition-all focus:outline-none"
